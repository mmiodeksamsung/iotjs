...
// example from here: https://tls.mbed.org/kb/how-to/mbedtls-tutorial
...
#define SERVER_PORT_STR "443"
#define SERVER_NAME "developer.mbed.org"
#define GET_REQUEST "GET /media/uploads/mbed_official/hello.txt HTTP/1.1\r\nHost: " SERVER_NAME "\r\n\r\n"
...
JHANDLER_FUNCTION(Test) {
    ...
    if( ( ret = mbedtls_net_connect( &server_fd, SERVER_NAME,
                                         SERVER_PORT_STR, MBEDTLS_NET_PROTO_TCP ) ) != 0 )
    {
...
iotjs_jval_t InitTls() {
    iotjs_jval_t tls = iotjs_jval_create_object();

    iotjs_jval_set_method(&tls, "test", Test);
